package ff.tweaker
{
	public class Unsigned extends Item
	{
		public function Unsigned( options:Object )
		{
			var setup:Array = [
				...
				[ "m_min", "min", uint, uint.MIN_VALUE ],
				[ "m_max", "max", uint, uint.MAX_VALUE ],
				[ "m_step", "step", uint, 1 ],
				[ "m_altStep", "altStep", uint, 5 ],
		...
		private function ChangeValue( d:int ):void
		{
			if ( m_object[m_property] != undefined )
			{
				var value:uint = m_object[m_property];
		...
		private var m_min:uint;
		private var m_max:uint;
		private var m_step:uint;
		private var m_altStep:uint;
